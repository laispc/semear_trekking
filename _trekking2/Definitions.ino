...
#define MAXIMUMMOTORPOWER 50  //potencia maxima dos motores (para uso da sabertooth, o sinal 0 corresponde à potencia máxima para frente, 255 para trás, e 128 parado)
...
//variáveis GPS
TinyGPS gps;
float LATPOINT[3] = {-22.006288528, -22.006283787084158, -22.006701567303146};//coordenadas em latitude dos objetivos
float LONPOINT[3] = {-47.898330688, -47.898066490888596, -47.89872094988823};//coordenadas em longitude dos objetivos
...
char imuRead;
char yawArray[15];
float COMPASS_REFERENCE_ANGLE = 105.20;; 		// Compass reference angle.
float rotAngle = 0;
